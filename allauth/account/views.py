...
class RedirectAuthenticatedUserMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        if request.user.is_authenticated and \
                account_appsettings.AppSettings.AUTHENTICATED_LOGIN_REDIRECTS:
...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    template_name = "account/login." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
    success_url = None
    ...
    def get_form_class(self):
        return get_form_class(account_appsettings.AppSettings.FORMS, 'login', self.form_class)
...
class CloseableSignupMixin(object):
    template_name_signup_closed = (
        "account/signup_closed." + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
...
class SignupView(RedirectAuthenticatedUserMixin, CloseableSignupMixin,
    ...
    template_name = "account/signup." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
    ...
    def get_form_class(self):
        return get_form_class(account_appsettings.AppSettings.FORMS, 'signup', self.form_class)
    ...
    def form_valid(self, form):
        ...
        try:
            return complete_signup(
                ...
                account_appsettings.AppSettings.EMAIL_VERIFICATION,
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    template_name = "account/email_confirm." + account_appsettings.AppSettings.TEMPLATE_EXTENSION

    def get(self, *args, **kwargs):
        try:
            self.object = self.get_object()
            if account_appsettings.AppSettings.CONFIRM_EMAIL_ON_GET:
    ...
    def post(self, *args, **kwargs):
        ...
        if account_appsettings.AppSettings.LOGIN_ON_EMAIL_CONFIRMATION:
    ...
    def login_on_confirm(self, confirmation):
        ...
        if user_pk == user.pk and self.request.user.is_anonymous:
            return perform_login(self.request,
                                 user,
                                 account_appsettings.AppSettings.EmailVerificationMethod.NONE,
...
class EmailView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "account/email." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
    form_class = AddEmailForm
    success_url = reverse_lazy('account_email')

    def get_form_class(self):
        return get_form_class(account_appsettings.AppSettings.FORMS, 'add_email', self.form_class)
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = (
        "account/password_change." + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
    form_class = ChangePasswordForm
    success_url = reverse_lazy("account_change_password")

    def get_form_class(self):
        return get_form_class(account_appsettings.AppSettings.FORMS,
                              'change_password',
                              self.form_class)
...
class PasswordSetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "account/password_set." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
...
class PasswordResetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "account/password_reset." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
...
class PasswordResetDoneView(TemplateView):
    template_name = (
        "account/password_reset_done." + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
...
class PasswordResetFromKeyView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = (
        "account/password_reset_from_key." + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
    ...
    def form_valid(self, form):
        ...
        if account_appsettings.AppSettings.LOGIN_ON_PASSWORD_RESET:
...
class PasswordResetFromKeyDoneView(TemplateView):
    template_name = (
        ...
        account_appsettings.AppSettings.TEMPLATE_EXTENSION)
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = "account/logout." + account_appsettings.AppSettings.TEMPLATE_EXTENSION
    redirect_field_name = "next"

    def get(self, *args, **kwargs):
        if account_appsettings.AppSettings.LOGOUT_ON_GET:
            return self.post(*args, **kwargs)
...
class AccountInactiveView(TemplateView):
    template_name = (
        'account/account_inactive.' + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
...
class EmailVerificationSentView(TemplateView):
    template_name = (
        'account/verification_sent.' + account_appsettings.AppSettings.TEMPLATE_EXTENSION)
